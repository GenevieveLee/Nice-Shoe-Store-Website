...
<head>
    ...
    <title>Nicee - Terms of Use</title>
    <link rel="stylesheet" href="../styles/header.css">
    <link rel="stylesheet" href="../styles/footer.css">
    <link rel="stylesheet" href="../styles/privacy&terms&faq.css">
...
<body>
    ...
    <div class="infoContainer">
        <h1>TERMS OF USE</h1>
        <h6>Lasted updated April 03, 2024</h6>
        <h3>AGREEMENT TO OUR LEGAL TERMS</h3>
        <p>
            We are Nicee ("<span class="darkgrayfont">Company</span>, <span class="darkgrayfont">we</span>," "<span
                class="darkgrayfont">us</span>," or "<span class="darkgrayfont">our</span>"),
        </p>
        <p>
            We operate , as well as any other related products and services that refer or link to
            these legal terms (the "<span class="darkgrayfont">Legal Terms</span>") (collectively, the "<span
                class="darkgrayfont">Services</span>").
        </p>
        <p>
            You can contact us by email at <span class="darkgrayfont"><a
                    href="https://mail.google.com/mail/u/0/?view=cm&fs=1&tf=1&source=mailto&to=customerservice@nicee.com"
                    target="_blank" title="Send Email"
                    style="color: #707070; text-decoration: underline;">customerservice@nicee.com</a></span> or by
            mail to <span class="darkgrayfont">Nicee, 111 Bijoy sarani, Dhaka, DH 1515, Bangladesh.</span>
        </p>
        <p>
            These Legal Terms constitute a legally binding agreement made between you,
            whether personally or on behalf of an entity ("you"), and Nicee, concerning
        ...
        <h3 id="contenttable">TABLE OF CONTENTS</h3>
        <a href="#content1">1. OUR SERVICES</a><br>
        <a href="#content2">2. INTELLECTUAL PROPERTY RIGHTS</a><br>
        <a href="#content3">3. USER REPRESENTATIONS</a><br>
        <a href="#content4">4. PROHIBITED ACTIVITIES</a><br>
        <a href="#content5">5. USER GENERATED CONTRIBUTIONS</a><br>
        <a href="#content6">6. CONTRIBUTION LICENSE</a><br>
        <a href="#content7">7. SERVICES MANAGEMENT</a><br>
        <a href="#content8">8. TERM AND TERMINATION</a><br>
        <a href="#content9">9. MODIFICATIONS AND INTERRUPTIONS</a><br>
        <a href="#content10">10. GOVERNING LAW</a><br>
        <a href="#content11">11. DISPUTE RESOLUTION</a><br>
        <a href="#content12">12. CORRECTIONS</a><br>
        <a href="#content13">13. DISCLAIMER</a><br>
        <a href="#content14">14. LIMITATIONS OF LIABILITY</a><br>
        <a href="#content15">15. INDEMNIFICATION</a><br>
        <a href="#content16">16. USER DATA</a><br>
        <a href="#content17">17. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</a><br>
        <a href="#content18">18. MISCELLANEOUS</a><br>
        <a href="#content19">19. CONTACT US</a><br>

        <h3 id="content1">1. OUR SERVICES</h3>
        <p>
        ...
        <h3 id="content2">2. INTELLECTUAL PROPERTY RIGHTS</h3>
        ...
        <ul>
            ...
            <p>
                ...
                us. If we ever grant you the permission to post, reproduce, or publicly
            ...
            <p>
                Please review this section and the "<a href="#content4">PROHIBITED ACTIVITIES</a>" section carefully
                prior
            ...
            <p>
                <span class="darkgrayfont">You are responsible for what you post or upload:</span> By sending us
                Submissions
                through any part of the Services you:
            </p>
            <ul>
                <li>
                    confirm that you have read and agree with our "<a href="#content4">PROHIBITED ACTIVITIES"</a>
            ...
            <h3 id="content3">3. USER REPRESENTATIONS</h3>
            <p>
            ...
            <h3 id="content4">4. PROHIBITED ACTIVITIES</h3>
            <p>
            ...
            <h3 id="content5">5. USER GENERATED CONTRIBUTIONS</h3>
            <p>
            ...
            <h3 id="content6">6. CONTRIBUTION LICENSE</h3>
            <p>
            ...
            <h3 id="content7">7. SERVICES MANAGEMENT</h3>
            <p>
            ...
            <h3 id="content8">8. TERM AND TERMINATION</h3>
            <p>
            ...
            <h3 id="content9">9. MODIFICATIONS AND INTERRUPTIONS</h3>
            <p>
            ...
            <h3 id="content10">10. GOVERNING LAW</h3>
            <p>
                These Legal Terms shall be governed by and defined following the laws of Malaysia. Nicee and yourself
                irrevocably consent that the courts of Malaysia shall have exclusive jurisdiction to resolve any dispute
                which may arise in connection with these Legal Terms.
            </p>

            <h3 id="content11">11. DISPUTE RESOLUTION</h3>
            ...
            <p>
                ...
                expressly provided below) informally for at least 7 days before initiating
            ...
            <p>
                ...
                Malaysia. The number of arbitrators shall be determined by mutual agreement of the parties or, failing
                such agreement, by the Malaysian Arbitration Act. The seat, or legal place, of arbitration shall be
                Kuala Lumpur. The language of the proceedings shall be English. The governing law of these Legal Terms
                shall be the
            ...
            <h3 id="content12">12. CORRECTIONS</h3>
            <p>
            ...
            <h3 id="content13">13. DISCLAIMER</h3>
            <p>
                ...
                MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, AND NONINFRINGEMENT. WE MAKE NO WARRANTIES OR
            ...
            <h3 id="content14">14. LIMITATIONS OF LIABILITY</h3>
            <p>
            ...
            <h3 id="content15">15. INDEMNIFICATION</h3>
            <p>
            ...
            <h3 id="content16">16. USER DATA</h3>
            <p>
            ...
            <h3 id="content17">17. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</h3>
            <p>
            ...
            <h3 id="content18">18. MISCELLANEOUS</h3>
            <p>
            ...
            <h3 id="content19">19. CONTACT US</h3>
            <p>
                In order to resolve a complaint regarding the Services or to receive further
                information regarding use of the Services, please contact us at <a
                    href="http://localhost/Nicee/contact/contact.php">here</a>.
            </p>
